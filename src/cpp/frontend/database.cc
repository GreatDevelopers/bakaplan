 ...
 *       \file       database.cc
 *
 *       \brief      Definition of functions for database connectivity
 ...
 *      \brief  Constructor to initialize database connectivity
 */
 ...
 *      \param  query   Holding MySQL Query
 */
...
/**
 *      \fn     Database :: UpdateQuery(string table, string column, 
 *                                      string value, string where)
 *      \brief  Updating values in table
